...
<body class="po">
	...
	%>
	<div class="header" style="background-color: #8C65D3;">
		...
		<button class="navbar-toggler" type="button" data-toggle="collapse"
			...
			<span class="navbar-toggler-icon"></span><i class="fas fa-bars" style="color:#fff; font-size: 28px;"></i>
		</button>
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto">
				<a class="nav-link" href="#"> <span class="sr-only">(bijli)</span>
				</a>
				<%
					if (userLoggedIn) {
				%>
				...
				<li class="nav-item dropdown"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						</a> <a class="dropdown-item" target="blank" href="<%=ORSView.JAVA_DOC_VIEW%>"><i
